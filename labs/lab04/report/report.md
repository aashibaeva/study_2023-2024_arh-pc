...
![Заполнение файла](image/4-11.jpg){ #fig:004 width=70% }
...
![Создании копии файлов в новом каталоге](image/15.jpg){ #fig:015 width=70% }

Удаляю лишние файлы в текущем каталоге с помощью утилиты rm, ведь копии файлов остались в другой директории (рис. [-@fig:016]).

![Удаление лишних файлов в текущем каталоге](image/16.jpg){ #fig:016 width=70% }
...
![Добавление файлов на GitHub](image/17.jpg){ #fig:017 width=70% }

Отправляю файлы на сервер с помощью команды git push (рис. [-@fig:018]).

![Отправка файлов](image/18.jpg){ #fig:018 width=70% }
