...
![Ввод текста программы из листинга 10.1](image/2.jpg){#fig:002 width=70%} 
...
![Предоставление прав доступа в символьном и двоичном виде](image/6.jpg){#fig:006 width=70%}
...
![Запуск исполняемого файла и проверка его работы](image/8.jpg){#fig:008 width=70%}
